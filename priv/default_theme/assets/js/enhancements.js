...
(function () {
  ...
  document.querySelectorAll(selector).forEach(function (block) {
    ...
    header.innerHTML =
      ...
      '<svg class="code-copy-icon code-copy-icon-check icon-check" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" aria-hidden="true"><path d="M20 6 9 17l-5-5"/></svg>' +
    ...
    btn.addEventListener("click", function () {
      var code = btn.closest(".code-block-wrap").querySelector("code").textContent;
      navigator.clipboard
        .writeText(code)
        .then(function () {
