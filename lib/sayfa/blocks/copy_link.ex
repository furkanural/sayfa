defmodule Sayfa.Blocks.CopyLink do
  ...
  def render(assigns) do
    ...
    """
    <button data-action="copy-link" data-copy-text="#{copy_link_text}" data-copied-text="#{copied_text}" class="copy-link-btn">\
      <svg class="icon-4" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" aria-hidden="true"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>\
