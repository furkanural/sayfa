    ...
    (function() {
      document.querySelectorAll('#{selector}').forEach(function(block) {
        ...
        header.innerHTML = '<span class="text-xs font-mono">' + lang + '</span>' +
          ...
          '<span class="copy-label">#{copy_text}</span></button>';
        pre.style.margin = '0';
