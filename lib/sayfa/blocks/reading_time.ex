defmodule Sayfa.Blocks.ReadingTime do
  ...
  def render(assigns) do
    ...
    if minutes do
      ...
      "<span class=\"content-meta-item\"><svg class=\"icon-4\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" viewBox=\"0 0 24 24\" aria-hidden=\"true\"><circle cx=\"12\" cy=\"12\" r=\"10\"/><polyline points=\"12 6 12 12 16 14\"/></svg>#{label}</span>"
    else
      ""
    end
  end
